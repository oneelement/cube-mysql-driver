...
describe('MySqlDriver', () => {
    ...
    beforeAll(async () => {
        container = await testing_shared_1.MysqlDBRunner.startContainer({});
        mySqlDriver = mysql_db_runner_1.createDriver(container);
    ...
    test('stream', async () => {
        await mySqlDriver.uploadTable('test.streaming_test', [
            { name: 'id', type: 'bigint' },
